...
ORDER BY total;
 ...
 -- ORDER BY komutunun DEFAULT değeri ASC dir.

--soru:/*invoices tablosunda Total değeri 10$'dan büyük olan kayıtlardan işlem tarihi 
...
ORDER BY InvoiceDate DESC
LIMIT 1;
/* customers tablosunda Belgium, Norway veya USA, Canada  ülkelerinden sipariş veren
